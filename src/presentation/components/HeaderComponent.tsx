...
export const HeaderComponent = () => {
  ...
  return (
    <>
      <header className="bg-[#FFB208] pr-[9rem] flex gap-x-5 justify-end text-white py-3 items-center">
      ...
      <div className="flex justify-around px-24 items-center py-5">
        ...
        <div className="flex gap-x-7 items-center">
          <CiSearch size={30} className="text-[#FFB208]" />
          <IoBagOutline size={30} className="text-[#FFB208]" />
          <div className="bg-[#FFB208]  px-1 py-2 rounded-md">
